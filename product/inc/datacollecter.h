...
typedef struct IOFunctionList
{
    ...
    UINT32 paramtype;                            ///< 数据类型按照最多8个参数排列8 x 4bits = 32bits
    ///< [31:28][27:24][23:20][19:16][15:12][11:8][7:4][3:0]
    string regName;                                                         ///< 采集函数的输入参数, 按照目前的规律X:Y.Z，
    ///< 第一个参数是cxt，
...
public:
    ...
    INT32 JobFunctionCall( pJobFunc JobFunc, UINT32 retpos, UINT32 paramNum, VOID **paramList );
		...
		UINT8 ParseParamsFromRegName( string regName, INT32 *param1, INT32 *param2, INT32 *param3 );
